...
<section id="sectionmenu">
    ...
    <div class="anchors">
    	<div class="contanchors">
            <a href="#sectionprices"><img class="anchortop" alt="" src="wp-content/themes/SweetCupCake/img/anchors/topskills.png" /></a>
            <a href="#sectioncontact"><img class="anchorbottom" alt="" src="wp-content/themes/SweetCupCake/img/anchors/bottomskills.png" /></a>
        </div>
    </div>
    <!--end anchors-->
